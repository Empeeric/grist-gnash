...
describe('Incremental update', function () {
    function updCheck(obj, upd, target, upsert) {
        var updater = new Updater(upd);
        updater.update(obj, upsert);
    ...
    describe("$push", function () {
        it("#1 $push basics", function (done) {
            ...
            var updater = new Updater({$push: {scores: 25, age: 17, "my.rating": 12}});
            updater.update(obj);
        ...
        it("#2 $push with each", function (done) {
            ...
            var updater = new Updater({$push: {scores: {$each: [25, 26]}, age: {$each: [17, 18]}}});
            updater.update(obj);
        ...
        it("#3 $push on non array throws error", function (done) {
            ...
            var updater = new Updater({$push: {scores: 2}});
            assert.throws(function () {updater.update(obj);}, /Cannot apply \$push\/\$pushAll modifier to non-array/);
            done();
        })
    });
    ...
    describe("$pushAll", function () {
        it("#1 $pushAll basics", function (done) {
            var obj = {_id: 1, scores: [1]};
            var updater = new Updater({$pushAll: {scores: [25, 26], age: [17, 18]}});
            updater.update(obj);
            assert.deepEqual(obj.age, [17, 18]);
            assert.deepEqual(obj.scores, [1, 25, 26]);
            done();
        ...
        it("#2 $pushAll on non array throws error", function (done) {
            ...
            var updater = new Updater({$pushAll: {scores: [12, 11]}});
            assert.throws(function () {updater.update(obj);}, /Cannot apply \$push\/\$pushAll modifier to non-array/);
            done();
        })
    });
    ...
    describe("$addToSet", function () {
        it("#1 $addToSet basics", function (done) {
            ...
            var updater = new Updater({$addToSet: {scores: 17, height: 63, age: 17, grade: {$each: [13, 14]}}});
            updater.update(obj);
        ...
        it("#2 $addToSet with $each", function (done) {
            var obj = {_id: 2, scores: [25]};
            var updater = new Updater({$addToSet: {scores: {$each: [25, 17]}}});
            updater.update(obj);
            assert.deepEqual(obj.scores, [25, 17]);
            done();
        });
        ...
        it("#3 $addToSet on non array throws error", function (done) {
            var obj = {_id: 3, scores: 25};
            var updater = new Updater({$addToSet: {scores: -1}});
            assert.throws(function () {updater.update(obj);}, /Cannot apply \$addToSet modifier to non-array/);
            done();
        })
    });
    ...
    describe("$pop", function () {
        it("#1 $pop basics", function (done) {
            ...
            var updater = new Updater({$pop: {scores: -1, age: 1, ratings: 1, "sub.scores": -1}});
            updater.update(obj);
        ...
        it("#1.1 $pop basics", function (done) {
            ...
            var updater = new Updater({$pop: {scores: -1, age: 1, ratings: 1, "sub.scores": -1, grades: -2}});
            assert.throws(function () {updater.update(obj);}, /Invalid \$pop argument `\-2` for field `grades`/);
            done();
        });

        it("#2 $pop on non array throws error", function (done) {
            var obj = {_id: 2, scores: 25};
            var updater = new Updater({$pop: {scores: -1}});
            assert.throws(function () {updater.update(obj);}, /Cannot apply \$pop modifier to non-array/);
            done();
        });

        it("#3 $pop with one or zero elements", function (done) {
            var obj = {_id: 3, scores: [], age: [16], ratings: [3]};
            var updater = new Updater({$pop: {scores: -1, age: 1, ratings: 1}});
            updater.update(obj);
        ...
        it("#4 $pop on non existent field does nothing", function (done) {
            ...
            var updater = new Updater({$pop: {"jmores.fores": -1, "pores": 1}});
            updater.update(obj);
    ...
    describe("$pull", function () {
        it("#1 $pull basics", function (done) {
            var obj = {_id: 1, sub: {scores: [11, 12]}, scores: [25, 27], age: [16, 17, 18], ratings: [3, 4, 5]};
            var updater = new Updater({$pull: {scores: 25, age: {$gt: 17}, ratings: {$in: [3, 4]}, "sub.scores": {$gte: 12}}});
            updater.update(obj);
            assert.deepEqual(obj.scores, [27]);
            assert.deepEqual(obj.age, [16, 17]);
        ...
        it("#2 $pull on non array throws error", function (done) {
            var obj = {_id: 2, scores: 25};
            var updater = new Updater({$pull: {scores: -1}});
            assert.throws(function () {updater.update(obj);}, /Cannot apply \$pull\/\$pullAll modifier to non-array/);
            done();
        });

        it("#3 $pull on non existent field does nothing", function (done) {
            var obj = {_id: 3, scores: 25};
            var updater = new Updater({$pull: {"jmores.fores": -1, "pores": 1}});
            updater.update(obj);
    ...
    describe("$pullAll", function () {
        it("#1 $pullAll basics", function (done) {
            ...
            var updater = new Updater({$pullAll: {"sub.scores": [12, 14], age: [16, 18, 20]}});
            updater.update(obj);
            assert.deepEqual(obj.age, [17]);
        ...
        it("#2 $pull on non array throws error", function (done) {
            var obj = {_id: 2, scores: 25};
            var updater = new Updater({$pullAll: {scores: [20]}});
            assert.throws(function () {updater.update(obj);}, /Cannot apply \$pull\/\$pullAll modifier to non-array/);
            done();
        });
        ...
        it("#3 $pull on non existent field does nothing", function (done) {
            var obj = {_id: 3, scores: 25};
            var updater = new Updater({$pullAll: {"jmores.fores": [12], "pores": [11]}});
            updater.update(obj);
            assert.deepEqual({_id: 3, scores: 25}, obj);
            done();
        })
    ...
    describe("hasAtomic", function () {
        it("check for atomic ops", function (done) {
            var updater = new Updater({$pullAll: {"jmores.fores": [12], "pores": [11]}});
            assert(updater.hasAtomic());
            done();
        })
    })
});
